...
* ## Week1 
  ...
  * [The Impossible Machine]
  ![](https://github.com/yuanfang313/CIM642_Physical_Computing/blob/master/Hw/Hw1_The%20Impossible%20Machine.jpg?raw=true)
 ...
 **Senario:** when users swip their cards, the force added on the levels of turnstile will be release, and users can push in through turnstile;
   ...
   *  **Trigger:**  a card touches or passes by the swipe-card reader;  
   
   *  **Active Output:** the red led turns green, and the force added on the levels released;
...
**Senario:** when users walk in a certain area in the Book Deposit in the library, the ceiling light will be awaked immediately;
   ...
   *  **Trigger:**  the sound of users;
   
   *  **Active Output:** the light is awaked;
   
   &nbsp;
   
  ### 5_Auto Door for Disables
   
   **Senario:** when users press the button outside the auto door, it will open immediately;
    
   *  **Passitive Input;**
    
   *  **What is user doing:** push the butto  
   
   *  **Active Output:** the door open;
    
   &nbsp;
    
  ### 6_The Redesign of Auto Door
   
  **Senario:** when users near the auto door, it will open immediately;
   
   *  **Active Input;**
   
   *  **Trigger:**  signal sent by a small microconcroller carrying by users; 
